   ...
   public class TotalStrengthBL
    {
        ...
        public static void displayTotalStrength(Repeater rpt)
        {
            ...
            try
            {
                ...
                string SqlString = "SELECT CPT_ResourceMaster.EmployeeMasterID, CPT_ResourceMaster.EmployeetName,[dbo].[Owner](CPT_ResourceDemand.ResourceRequestBy) as RequestedBy, " +
                                   " 100 * CPT_AllocateResource.Utilization as Utilization," +
                                   ...
                                   " CPT_AllocateResource.ResourceID = CPT_ResourceMaster.EmployeeMasterID " + " WHERE CPT_ResourceMaster.RolesID  NOT IN (1,4,5,8,15,20,26,25)" +
                                   " AND ISDeployed=1 and ISDELETED =0 ORDER BY CPT_ResourceMaster.EmployeetName";
        ...
        public static void displayResourcePlan(Repeater rpt)
        {
            ...
            try
            {
                ...
                string SqlString = "SELECT CPT_ResourceMaster.EmployeeMasterID, CPT_ResourceMaster.EmployeetName," +
                                   ...
                                   " CPT_ResourceDemand ON CPT_AllocateResource.RequestID = CPT_ResourceDemand.RequestID RIGHT OUTER JOIN " +
                                   " CPT_ResourceMaster INNER JOIN " + " CPT_DesignationMaster ON CPT_ResourceMaster.DesignationID = CPT_DesignationMaster.DesignationMasterID ON " +
                                   " CPT_AllocateResource.ResourceID = CPT_ResourceMaster.EmployeeMasterID " + " WHERE CPT_ResourceMaster.RolesID  NOT IN (1,4,5,8,15,20,26,25)  AND ISDeployed = 1 ORDER BY CPT_ResourceMaster.EmployeetName";
                using (SqlCommand SqlCom = new SqlCommand(SqlString, SqlConn))
                {
                    SqlConn.Open();
                    rpt.DataSource = SqlCom.ExecuteReader();
