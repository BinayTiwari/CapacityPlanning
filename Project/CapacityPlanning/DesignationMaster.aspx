...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidatorDesignation" SetFocusOnError="true" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="DesignationNameTextBox"
            ValidationExpression="^[A-Za-z][A-Za-z ]+$" ErrorMessage="*Only Alphabets are allowed." />
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDesignation" runat="server" ForeColor="Red" Display="Dynamic" ControlToValidate="DesignationNameTextBox" 
                        ...
                        <asp:GridView ID="gvDesignation" runat="server" DataKeyNames="DesignationMasterID" OnPageIndexChanging="OnPageIndexChanging" PageSize="10"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <EditItemTemplate>
                                        <asp:ImageButton ImageUrl="~/images/yes.png" Width="25px" Height="25px" CausesValidation="false" ID="ButtonUpdate" runat="server" CommandName="Update" formnovalidate />
