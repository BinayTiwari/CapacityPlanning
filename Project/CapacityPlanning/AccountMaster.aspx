    ...
    <div class="col-md-10">
        ...
        <div class="content-box-large">
            <div class="form-group form-inline">
                <asp:TextBox ID="AccountNameTextBox" placeholder="Account Name" CssClass="form-control" runat="server"></asp:TextBox>
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" DataKeyNames="AccountMasterID" CellPadding="8" OnPageIndexChanging="OnPageIndexChanging" PageSize="5"
