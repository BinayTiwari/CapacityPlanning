...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        <div class="form-group form-inline col-lg-12">
            ...
            <asp:Button ID="SalesStageAddButton" runat="server" Text="Add SalesStage" CssClass="btn btn-md btn-success" OnClick="SalesStageAddButton_Click" CausesValidation="False" />
        </div>
