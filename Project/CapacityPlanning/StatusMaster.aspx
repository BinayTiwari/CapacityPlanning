...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-10">
        <div class="content-box-header panel-heading" style="color: white; background-color: #07838a">
            <div class="panel-title ">Status Master</div>
        </div>
        ...
        <div class="content-box-large">
            ...
            <asp:GridView ID="gvStatus" Width="100%" runat="server" DataKeyNames="StatusMasterID" CellPadding="8" OnPageIndexChanging="OnPageIndexChanging" PageSize="10"
                ...
                <Columns>
                    <asp:BoundField DataField="StatusMasterID" ReadOnly="true" HeaderText="Status ID" />
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:ImageButton ID="DeleteButton" runat="server" ImageUrl="~/images/trash.png"
                                CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this Status?');"
