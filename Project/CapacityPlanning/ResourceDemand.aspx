...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <div class="row">
               ...
               <div class="row">
                   <div style="float: right;">        <asp:Button ID="ResourceDemandAddButton" runat="server" Text="Add Resource Demand" class="btn btn-primary"
                        PostBackUrl="AddResourceDemand.aspx" /></div>
                                ...
                                <ItemTemplate>
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center" ><a href="EditResourceDemand.aspx?RequestId=<%#Eval("RequestId")%>">
                                                    <ul><i class="fa fa-fw" aria-hidden="true" title="Edit"></i>
