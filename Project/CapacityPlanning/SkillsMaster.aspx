<%@ Page Title="Skill Master" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SkillsMaster.aspx.cs" Inherits="CapacityPlanning.SkillsMaster" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-10">
        <div class="content-box-header panel-heading" style="color: white; background-color: #07838a">
            <div class="panel-title ">Skills Master</div>
        </div>
        ...
        <div class="content-box-large">
            ...
            <asp:GridView ID="GridView1" Width="100%" runat="server" DataKeyNames="SkillsMasterID" CellPadding="8" OnPageIndexChanging="OnPageIndexChanging" PageSize="5"
                ...
                <Columns>
                    <asp:BoundField DataField="SkillsMasterID" ReadOnly="true" HeaderText="Skills ID" />
