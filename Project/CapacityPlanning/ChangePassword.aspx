            ...
            <div class="login-box">
                ...
                <div class="login-box-body">
                    ...
                    <div class="form-group has-feedback">
                        <asp:TextBox ID="txtPass" TextMode="Password" CssClass="form-control" placeholder="New Password" runat="server" required ></asp:TextBox>
                        <span class="fa fa-user form-control-feedback"></span><span><font color="red"></font></span>
                    </div>

                    <div class="form-group has-feedback">
                        <asp:TextBox ID="txtConfirm" CssClass="form-control" TextMode="Password" placeholder="Confirm Password" runat="server" required></asp:TextBox>
                    ...
                    <div class="row">
                        <div class="col-12 text-right">
                            ...
                            <asp:Button CssClass="btn btn-danger signup" ID="btnCancel" runat="server" Text="Cancel" OnClick="Cancel" formnovalidate />
